...
/**
 * Search filter for the DBColumn objects.
 *
 * @author Andisa Dewi, KNIME.com, Berlin, Germany
 * @since 3.4
 */
public class ColumnSearchFilter implements SearchFilter {

    private final Pattern m_regex;

    /**
     * Constructor for the Column search filter.
     *
     * @param regex the regular expression that should be matched
     */
    public ColumnSearchFilter(final Pattern regex) {
        m_regex = regex;
    }
