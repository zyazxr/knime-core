...
public class EditorGridSettingsDialog extends Dialog {
    ...
    private void settingsChanged() {
        ...
        EditorUIInformation.Builder builder = EditorUIInformation.builder(m_settings);
        builder.setSnapToGrid(m_snap.getSelection());
        builder.setShowGrid(m_show.getSelection());
