...
final class FormulasExpressionEditorDialog extends JDialog {
	 ...
	 */
	public FormulasExpressionEditorDialog(FormulasNodeDialog parent) {
		m_parent = parent;
	...
	public void setVisible(boolean visible) {
		...
		if (visible) {
			...
			m_snippetPanel.setExpressions(m_parent.getTable().getModel().getValueAt(selectedRow, FormulasNodeDialog.getExpressionColumn()).toString());
		}
	}
}
