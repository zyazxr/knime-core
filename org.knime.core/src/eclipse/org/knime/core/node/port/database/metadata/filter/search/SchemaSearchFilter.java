...
/**
 * Search filter for the DBSchema objects.
 *
 * @author Andisa Dewi, KNIME.com, Berlin, Germany
 * @since 3.4
 */
public class SchemaSearchFilter implements SearchFilter {

    private final Pattern m_regex;

    /**
     * Constructor for the Schema search filter.
     *
     * @param regex the regular expression that should be matched
     */
    public SchemaSearchFilter(final Pattern regex) {
        m_regex = regex;
    }
