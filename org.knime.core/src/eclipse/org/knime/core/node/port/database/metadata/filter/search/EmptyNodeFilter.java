...
/**
 * This filter will filter out DBObjects that are empty (have no children).
 *
 * @author Andisa Dewi, KNIME.com, Berlin, Germany
 * @since 3.4
 */
public class EmptyNodeFilter implements SearchFilter {

    private final boolean m_removeEmptySchema;

    /**
     * Constructor for the empty node filter.
     *
     * @param removeEmptySchema true if any empty schema should be removed, false to keep them
     */
    public EmptyNodeFilter(final boolean removeEmptySchema) {
        m_removeEmptySchema = removeEmptySchema;
    }
