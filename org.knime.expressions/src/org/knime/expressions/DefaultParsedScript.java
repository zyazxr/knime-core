...
public class DefaultParsedScript implements ParsedScript {
	...
	private final boolean m_containsROWID;
	private final boolean m_containsROWINDEX;
	private final boolean m_containsROWCOUNT;
	...
	public DefaultParsedScript(String script, Class<?> returnType, Map<String, Integer> parsedNameIndexMap,
		...
		this(script, returnType, parsedNameIndexMap, columnNameMap, columnIndexMap, columnFieldTypes, false, false,
				false);
	}
	 ...
	 *            Java types of the column fields.
	 * @param containsROWID
	 *            If the row id is used in the script.
	 * @param containsROWINDEX
	 *            If the row index is used in the script.
	 * @param containsROWCOUNT
	 *            If the row count is used in the script.
	 */
	public DefaultParsedScript(String script, Class<?> returnType, Map<String, Integer> parsedNameIndexMap,
			Map<String, String> columnNameMap, Map<String, Integer> columnIndexMap, Class<?>[] columnFieldTypes,
			boolean containsROWID, boolean containsROWINDEX, boolean containsROWCOUNT) {
		m_script = script;
