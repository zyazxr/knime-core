...
public interface AsyncWorkflowManagerUI extends WorkflowManagerUI, AsyncNodeContainerUI {
    ...
    /**
     * Refreshes the workflow (e.g. downloads the new state) and returns when done.
     *
     * @param deepRefresh if <code>true</code> the workflow itself and all contained sub-workflows (i.e. metanodes) will
     *            be refreshed, if <code>false</code> only the top level workflow will be refreshed
     * @throws JobSwappedException if refresh is not possible because the job-workflow has been swapped to disk (and
     *             removed from memory)
     */
    void refreshOrFailIfJobSwapped(final boolean deepRefresh) throws JobSwappedException;
