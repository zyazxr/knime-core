...
public final class OpenInteractiveWebViewAction extends Action {
     ...
     * @param webViewForNode The view for the node (note, for {@link SubNodeContainerUI}
    ...
    public OpenInteractiveWebViewAction(final NodeContainer nodeContainer,
        ...
        m_nodeContainer = NodeContainerWrapper.wrap(nodeContainer);
        m_webViewForNode = SingleInteractiveWebViewResultWrapper.wrap(webViewForNode);
