...
public final class SerializeUtil {
    ...
    /**
     * Load a {@link ConverterFactory} from given config.
     *
     * Use {@link #getPlaceholder(ConfigBaseRO, String)} to get information about the converter factory if it's missing.
     * To store a producer use {@link #storeConverterFactory(ConverterFactory, ConfigBaseWO, String)}.
     *
     * @param config Config to load from
     * @param registry Registry to load producer with
     * @param key setting key
     * @return an optional {@link ConverterFactory}, present if the factory identifier was found in the
     *         <code>registry</code>.
     * @throws InvalidSettingsException
     * @since 3.7
     */
