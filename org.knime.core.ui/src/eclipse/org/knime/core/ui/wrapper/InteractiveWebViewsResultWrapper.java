 ...
 */
public class InteractiveWebViewsResultWrapper extends AbstractWrapper<InteractiveWebViewsResult>
    implements InteractiveWebViewsResultUI {
     ...
     */
    public static final InteractiveWebViewsResultWrapper wrap(final InteractiveWebViewsResult delegate) {
        return (InteractiveWebViewsResultWrapper)Wrapper.wrapOrGet(delegate,
